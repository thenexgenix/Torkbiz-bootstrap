...
export default function SecondSignUpPage() {
  useEffect(() => {
    ...
    // Force recalculation like custom.js does
    setTimeout(() => {
      AOS.refreshHard();
    }, 50);

    // Apply stored theme (same as HTML)
  ...
  return (
    <>
      {/* ===== Light / Dark Switch (HTML accurate) ===== */}
                  ...
                  <div className="account__content account__content--style2">
                    ...
                    <div className="account__header">
                      ...
                      <p className="mb-0">
                        ...
                        and promotion updates. Contact us with questions.
